@forelse ($products as $product)
    ...
    <tr>
        ...
        <td>
            <input type="text" class="form-control label-date-picker"
            name="products[{{$loop->index + $index}}][packing_date]" value="<?=date('d/m/Y')?>">
        </td>
        <td>
            {!! Form::select('products[' . $row_index . '][price_group_id]', $price_groups, $key, ['class' => 'form-control', 'placeholder' => __('lang_v1.none')]); !!}
        </td>
    </tr>
@empty
