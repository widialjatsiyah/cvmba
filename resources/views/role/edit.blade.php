        ...
        @endif
         ...
         <div class="row check_group">
            ...
            <div class="col-md-2">
              <div class="checkbox">
                  <label>
                    <input type="checkbox" class="check_all input-icheck" > Pilih Semua
                  </label>
                </div>
            </div>
            <div class="col-md-9">
              <div class="col-md-12">
                <div class="checkbox">
                <label>
                    {!! Form::checkbox('permissions[]', 'transfer_stock.view', in_array('transfer_stock.view', $role_permissions), 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'Lihat Transfer Stok' ) }}
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'transfer_stock.create', in_array('transfer_stock.create', $role_permissions), 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'Buat Transfer Stok' ) }}
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'transfer_stock.update', in_array('transfer_stock.edit', $role_permissions), 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'Edit Transfer Stok' ) }}
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'transfer_stock.delete',  in_array('transfer_stock.delete', $role_permissions), 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'Hapus Transfer Stok' ) }}
                  </label>
                </div>
              </div>
