...
<section class="content">
	...
	@component('components.widget', ['class' => 'box-primary'])
		...
		@if(!empty($custom_field_1_label))
			...
			<div class="col-md-4 hide">
		        <div class="form-group">
		            ...
		            {!! Form::text('custom_field_1', 1, ['class' => 'form-control','placeholder' => $custom_field_1_label, 'required' => $is_custom_field_1_required]); !!}
		        </div>
		    </div>
		@endif
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="form-group">
					{!! Form::label('sells_ids', 'Faktur Penjualan :') !!}
					{!! Form::select('sells_ids[]', [] , null, ['class' => 'form-control select2', 'multiple', 'id' => 'sells_ids']); !!}
				</div>
			</div>
		</div>
		@endif
...
@section('javascript')
	<script src="{{ asset('js/purchase.js?v=' . $asset_v+2) }}"></script>
