  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group hide">
        ...
        <br>
        @if($purchase->custom_field_1==1)
        <span class="label bg-info">Menunggu Persetujuan</span>
        {!! Form::text('custom_field_1', $purchase->custom_field_1, ['class' => 'form-control hide','placeholder' => $custom_field_1_label, 'required' => $is_custom_field_1_required]); !!}
        @elseif($purchase->custom_field_1==2)
        <span class="label bg-green">Disetujui</span>
        {!! Form::text('custom_field_1', $purchase->custom_field_1, ['class' => 'form-control hide','placeholder' => $custom_field_1_label, 'required' => $is_custom_field_1_required]); !!}
        @elseif($purchase->custom_field_1==3)
        <span class="label bg-red">Ditolak</span>
        {!! Form::text('custom_field_1', $purchase->custom_field_1, ['class' => 'form-control hide','placeholder' => $custom_field_1_label, 'required' => $is_custom_field_1_required]); !!}
        
        @else
        <select name="custom_field_1" id="custom_field_1" class="form-control">
          <option value="">Belum Diajukan</option>
