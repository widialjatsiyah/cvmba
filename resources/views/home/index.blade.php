...
<div class="row">
        <?php if(session('business.id') == 4){ ?>
        <div class="col-sm-12">
            <div class="alert alert-danger" role="alert">Masa Percobaan anda selama 3 bulan akan berakhir pada tanggal 31 Juli 2025. </div>
        </div>
        <?php } ?>
        <div class="col-md-5 col-xs-12">
                <h2 class="color-white">Hallo, {{ Session::get('user.first_name')}}
                </h2>
        </div>
...
<section class="content content-custom no-print">
    ...
    @if(auth()->user()->can('dashboard.data'))
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-xs-12 col-custom ">
                   <div class="info-box info-box-new-style bg-aqua-gardient">
                        <span class="info-box-icon bg-aqua-light"><i class="ion ion-ios-cart-outline text-aqua"></i></span>
                ...
                <div class="col-lg-6 col-md-12  col-xs-12 col-custom">
                    <div class="info-box info-box-new-style bg-green-gardient">
                       <span class="info-box-icon bg-green-light">
                            <i class="ion ion-ios-paper-outline text-green"></i>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style bg-yellow-gardient" >
                        <span class="info-box-icon bg-yellow-light text-yellow">
                ...
                <div class="col-lg-6 col-md-12  col-xs-12 col-custom">
                    <div class="info-box info-box-new-style bg-red-gardient">
                        <span class="info-box-icon bg-red-light text-red">
                ...
                <div class="col-lg-6 col-md-12  col-xs-12 col-custom">
                   <div class="info-box info-box-new-style bg-blue-gardient">
                        <span class="info-box-icon bg-aqua-light text-aqua"><i class="ion ion-cash"></i></span>
                ...
                <div class="col-lg-6 col-md-12  col-xs-12 col-custom">
                    <div class="info-box info-box-new-style bg-red-gardient">
                        ...
                        <!-- /.info-box-content -->
                        <p class="mb-0 text-muted fs-10 mt-1" style="color:#fff">{{ __('lang_v1.total_sell_return')}}: <span class="total_sr" style="color:#fff"></span><br>
                   ...
                   <div class="col-lg-6 col-md-12  col-xs-12 col-custom">
                    <div class="info-box info-box-new-style bg-red-gardient">
                       <span class="info-box-icon bg-red-light text-red">
                        ...
                        <!-- /.info-box-content -->
                         <p class="mb-0 text-muted fs-10 mt-1" style="color:#fff">{{ __('lang_v1.total_purchase_return')}}: <span class="total_pr" style="color:#fff"></span><br>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        <?php if(session('business.id') == 99){ ?>
         swal("Masa Percobaan Telah Habis","Masa Percobaan anda selama 3 bulan telah habis Penghapusan Automatis dalam 3 Hari",{
                // buttons: false,
                icon: "error",
