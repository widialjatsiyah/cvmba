  ...
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <div style="font-size:10px; font-weight:bolder">
           <span>@lang( 'cash_register.register_details' ) </span> 
          <br>
          
         <span>Buka Kasir :   {{ \Carbon::createFromFormat('Y-m-d H:i:s', $register_details->open_time)->format('d M, Y h:i A') }} </span> 
         <br>
         <span>Tutup Kasir : {{\Carbon::createFromFormat('Y-m-d H:i:s', $close_time)->format('d M, Y h:i A')}} </span>
      </div>
