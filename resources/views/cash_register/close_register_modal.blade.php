      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('closing_amount text-red', __( 'cash_register.total_cash' ) . ':*') !!}
              ...
              {!! Form::text('closing_amount', 0, ['class' => 'form-control input_number', 'required', 'placeholder' => __( 'cash_register.total_cash' ) ]); !!}
          </div>
        </div>
