<div class="row" style="font-size:8px">
  <div class="col-sm-12">
    <table class="table table-condensed">
      ...
      @php 
      $payment_types = array_filter($payment_types, function($value) {
            return strpos($value, "Pembayaran Kustom") === false; // Hanya ambil data tanpa "Pembayaran Kustom"
        });
        @endphp
  ...
  <div class="col-sm-12">
      ...
      <tr class="warning {{($register_details->closing_amount==0)?'hide':''}}" >
        <th>
         Total Setor Cash
        </th>
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{$register_details->closing_amount}}</span></b>
        </td>
      </tr>
      
      <tr class="{{($register_details->closing_amount==0)?'hide':''}}" style="border-top:2px dotted #000 !important; font-size:12px; font-weight:bolder">
        <th>
         Selisih
        </th>
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{$register_details->closing_amount-$register_details->total_cash}}</span></b>
        </td>
      </tr>
    </table>
  </div>
