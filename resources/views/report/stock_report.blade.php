              ...
              {!! Form::open(['url' => action([\App\Http\Controllers\ReportController::class, 'getStockReport']), 'method' => 'get', 'id' => 'stock_report_filter_form' ]) !!}
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('location_id', $business_locations, null, ['class' => 'form-control select2 location_id_filter', 'style' => 'width:100%']); !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('konsinyasi','Konsinyasi :') !!}
                        <select name="konsinyasi" id="konsinyasi" class="form-control select2">
...
@section('javascript')
    <script src="{{ asset('js/report.js?v=' . $asset_v+1) }}"></script>
@endsection