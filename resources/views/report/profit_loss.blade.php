...
<section class="content">
    ...
    <div class="row no-print">
        <div class="col-sm-12">
            <button type="button" class="btn rounded-pill btn-primary pull-right" 
                ...
                if(typeof profit_by_date_datatable == 'undefined') {
                    profit_by_date_datatable = $('#profit_by_date_table').DataTable({
                        ...
                        columns: [
                            ...
                            // { data: 'sum_purchase', "searchable": false},
                            // { data: 'sum_sell', "searchable": false},
                            { data: 'gross_profit', "searchable": false},
                            // { data: 'margin', "searchable": false},
                        ],
                        fnDrawCallback: function(oSettings) {
                            var total_profit = sum_table_col($('#profit_by_date_table'), 'gross-profit');
                            $('#profit_by_date_table .footer_total').text(__currency_trans_from_en(total_profit));
