            ...
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action([\App\Http\Controllers\ReportController::class, 'getStockReport']), 'method' => 'get', 'id' => 'product_sell_report_form' ]) !!}
               <div class="col-md-3">
                    ...
                    {!! Form::label('product_custom_field2', 'Supplier :') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-user"></i>
                            </span>
                             {!! Form::select('product_custom_field2', $suppliers, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'product_custom_field2_filter', 'placeholder' => __('lang_v1.all')]); !!}
...
@section('javascript')
    <script src="{{ asset('js/report.js?v=' . $asset_v+6) }}"></script>
    <script type="text/javascript">
        $(
        '#product_sell_report_form #location_id, #product_sell_report_form #customer_id, #psr_filter_brand_id, #psr_filter_category_id, #psr_customer_group_id, #product_custom_field2_filter'
    ).change(function() {
                        ...
                        product_sell_report_by_category_datatable = $('table#product_sell_report_by_category').DataTable({
                                ...
                                ajax: {
                                    ...
                                    data: function(d) {
                                        ...
                                        d.product_custom_field2 = $('select#product_custom_field2').val();
                                    },
                                },
                                columns: [
