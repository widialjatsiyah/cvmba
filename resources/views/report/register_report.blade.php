        ...
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action([\App\Http\Controllers\ReportController::class, 'getStockReport']), 'method' => 'get', 'id' => 'register_report_filter_form' ]) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('business_location_id',  __('business.business_locations') . ':') !!}
                       {!! Form::select('business_location_id', $business_locations, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('business.business_locations')]); !!}
                ...
                <table class="table table-bordered table-striped" id="register_report_table">
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 text-center footer-total">
                            ...
                            <td class="footer_cash_cashier"></td>
                            <td class="footer_selisih"></td>
                            <td></td>
                        </tr>
                    </tfoot>
                </table>
