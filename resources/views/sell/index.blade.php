...
@section('content')
    ...
    <section class="content no-print">
        ...
        @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_sales')])
            @can('direct_sell.access')
                @slot('tool')
                    <div class="box-tools">
                        <a class="btn btn-block btn-primary rounded-pill"
            ...
            @if (auth()->user()->can('direct_sell.view') ||
                ...
                <table class="table table-bordered table-striped ajax_view" id="sell_table">
                    <thead>
                        <tr>
                            <th><input type="checkbox" id="select-all-row" data-table-id="sell_table" title="@lang('lang_v1.select_all_rows')">
                            </th>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="7"><button type="button" class="btn btn-primary btn-xs" id="bulk-packing-btn"
                                    style="margin-left: 5px;"><i class="fas fa-box"></i> @lang('lang_v1.bulk_packing')</button>
                            </td>
                        </tr>
    ...
    @include('sell.partials.add_packing_modal')
        ...
        $(document).ready(function() {
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                createdRow: function(row, data, dataIndex) {
                    $(row).find('td:eq(0)').attr('class', 'select-checkbox');
            ...
            $(document).on('change',
                '#sell_list_filter_payment_type, #sell_list_filter_location_id, #sell_list_filter_customer_id, #sell_list_filter_payment_status, #created_by, #sales_cmsn_agnt, #service_staffs, #shipping_status, #sell_list_filter_source',
                function() {
                    sell_table.ajax.reload();
                });
            ...
            $(document).on('click', '#bulk-packing-btn', function(e) {
                e.preventDefault();
                ...
                if (selected_rows.length > 0) {
                    ...
                    var modal = $('#add_packing_modal');

                    modal.modal('show');
                    modal.find('#sell_to_packing').val(selected_rows);
                } else {
            ...
            $(document).on('submit', 'form#add_packing_form', function(e) {
                e.preventDefault();
                var form = $(this);
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.success == true) {
                            $('div#add_packing_modal').modal('hide');
                            toastr.success(result.msg);
                            product_table.ajax.reload();
                            $('form#add_packing_form')
