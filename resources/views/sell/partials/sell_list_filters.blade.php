...
<div class="col-md-3">
    <div class="form-group">
        {!! Form::label('sell_list_filter_payment_type',  __('Cara Bayar') . ':') !!}
        
        {!! Form::select("sell_list_filter_payment_type", $payment_types, null, ['class' => 'form-control col-md-12 payment_types_dropdown select2','style' => 'width:100%;', 'placeholder' => __('lang_v1.all')]); !!}
