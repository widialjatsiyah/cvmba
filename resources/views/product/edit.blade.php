             ...
             <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('supplier_id', 'Supplier :') !!} 
                 {!! Form::select('product_custom_field2', $suppliers, $product->product_custom_field2, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        @elseif($cf_type == 'dropdown')
                            {!! Form::select($db_field_name, $dropdown, $product->$db_field_name, ['placeholder' => 'Silahkan Pilih', 'class' => 'form-control select2']); !!}
                        @endif
                    </div>
                </div>
            @endif
