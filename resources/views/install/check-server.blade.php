        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-primary active" id="Installation">
            ...
            <div class="box-body">
              ...
              <a @if($output['next']) href="{{route('install.details')}}" @endif class="btn rounded-pill btn-primary pull-right @if(!$output['next']) disabled-link @endif" @if(!$output['next']) disabled onclick="return false;" @endif>Next</a>
            </div>
          <!-- /.box-body -->
          </div>
        </div>
