...
$(document).on('change', '#sell_list_filter_location_id, #sell_list_filter_customer_id, #sell_list_filter_payment_status, #created_by, #sales_cmsn_agnt, #service_staffs, #shipping_status,#sell_list_filter_payment_type',  function() {
    sell_table.ajax.reload();
});
...
sell_table = $('#sell_table').DataTable({
        ...
        "ajax": {
            ...
            "data": function ( d ) {
                ...
                if($('#sell_list_filter_payment_type').length && $('#sell_list_filter_payment_type').val()) {
...
// Container for Packing modal
$(document).ready(function() {
    if ($("#packing_modal_container").length <= 0) {
        $("body").append('<span id="packing_modal_container" class="modal-container"></span>');
    }
});
</script>