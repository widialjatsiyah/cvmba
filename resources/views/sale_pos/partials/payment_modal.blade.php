				...
				<div class="row">
						...
						<div class="box box-solid bg-navy">
				            <div class="box-body">
				            	...
				            	<hr>
				            		...
				            		<br/>
				            		<span class="lead text-bold change_return_span" style="font-size:30px">0</span>
					...
					<div class="col-md-12">
						...
						<div class="row  @if($change_return['amount'] == 0) hide @endif payment_row" id="change_return_payment_data">
							<div class="col-md-12">
								<div class="box box-solid payment_row bg-lightgray hide" >
									<div class="box-body" >
										<div class="col-md-4">
			        	...
			        	<button type="submit" class="btn btn-success btn-lg btn-block" id="pos-save">BAYAR</button>
						    </div>
						</div>
						<div class="row hide">
							<div class="col-md-6">
...
<div class="modal fade" tabindex="-1" role="dialog" id="card_details_modal">
	<div class="modal-dialog" role="document">
		...
		<div class="col-md-3">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary btn-block btn-lg" id="pos-save-card">@lang('sale.finalize_payment')!!!!</button>
			</div>
