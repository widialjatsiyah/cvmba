...
return [
    ...
    */
    ...
    'top_trending_products' => "Produk terlaris dari toko Anda. <br/><small class='text-muted'>Terapkan filter untuk mengetahui produk terlaris dalam Kategori, Merek, lokasi Gudang dll.</small>",
    ...
    'purchase_location' => 'lokasi Gudang dimana tempat produk yang dibeli akan tersedia untuk dijual.',

    'sale_location' => 'lokasi Gudang dari tempat Anda ingin menjual',
    ...
    'invoice_scheme' => "Skema Faktur juga format penomoran faktur. Pilih skema yang akan digunakan untuk lokasi Gudang ini<br><small class='text-muted'><i>Anda dapat menambahkan Skema Faktur baru </b> di Pengaturan Faktur</i></small>",

    'invoice_layout' => "Tata Letak Faktur yang akan digunakan untuk lokasi Gudang ini<br><small class='text-muted'>(<i>Anda dapat menambahkan <b> Tata Letak Faktur </b> baru di <b> Pengaturan Faktur<b></i>)</small>",
    ...
    'all_location_permission' => 'Jika <b> Semua Lokasi </b> dipilih, peran ini akan memiliki izin untuk mengakses semua lokasi Gudang',
