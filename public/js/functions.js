...
function applyTieredDiscount(price, discountString) {
    let result = price;

    discountString.split('+').forEach(function(discount) {
        discount = parseFloat(discount.trim()) || 0;
...
function reverseTieredDiscount(price, discountString) {
    let result = price;
