...
class Transaction extends Model
{
    ...
    {
        return $this->hasMany(\App\TransactionExpense::class, 'transaction_id');
    }
    ...
    public function salesOrders()
    {
       ...
       public function stock_opname_lines()
    {
        return $this->hasMany(\App\StockOpnameLine::class);
    }

    public function packing_details()
    {
    return $this->hasMany(\App\DetailPacking::class);
    }
