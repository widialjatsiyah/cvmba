...
class ExpenseController extends Controller
{
    ...
    public function create()
    {
        ...
        $accounts = Account::forDropdownAll($business_id, true, false, true);
        // }
    ...
    public function edit($id)
    {
        ...
        // Ambil transaksi dengan relasi expenseLines
        ...
        // Ambil expense lines
        $expense_lines = $expense->expenseLines;
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $request->validate([
                ...
                'expense_lines.*.category_id' => 'nullable|exists:expense_categories,id',
                'expense_lines.*.sub_category_id' => 'nullable|exists:expense_categories,id',
                'expense_lines.*.amount' => 'required|numeric|min:0',
                'expense_lines.*.line_description' => 'nullable|string|max:255',
            ]);
