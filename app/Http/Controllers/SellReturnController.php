...
class SellReturnController extends Controller
{
    ...
    private function receiptContent(
        ...
        if ($location_details->print_receipt_on_invoice == 1) {
            ...
            if ($receipt_printer_type == 'printer') {
                ...
                $output['html_content'] = view('sell_return.receipt_new', compact('receipt_details'))->render();
    ...
    // pin staff Validate
     public function validateStaffPinn($pin_staff){

        $business_id = request()->session()->get('user.business_id');
        $query = User::where('service_staff_pin', $pin_staff)->where('business_id', $business_id);
