...
Route::middleware(['setData'])->group(function () {
    ...
    Route::get('/login_mobile', [App\Http\Controllers\Auth\LoginController::class, 'showLoginForm_mobile'])->name('login_mobile');
    Route::post('/auth_mobile', [App\Http\Controllers\Auth\LoginController::class, 'AuthMobile'])->name('auth_mobile');
    Auth::routes();
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/products/save-selling-prices', [ProductController::class, 'saveSellingPrices']);
          ...
          // Tambahan  
    Route::post('/products/save-selling-prices-satuan', [ProductController::class, 'saveSellingPricesSatuan']);
    Route::get('/products/delete-satuan/{id}', [ProductController::class, 'deleteSatuan']);
    ...
    // Packing routes
    // Route::get('/Packing/create/{transactionIds}', [App\Http\Controllers\PackingController::class, 'create'])->where('transactionIds', '[0-9,]+');
    // Route::post('/Packing', [App\Http\Controllers\PackingController::class, 'store']);
    // Route::get('/Packing/{id}', [App\Http\Controllers\PackingController::class, 'show']);
    // Route::get('/Packing/history/{transactionId}', [App\Http\Controllers\PackingController::class, 'history']);
    Route::post('/packing/add-bulk-packing', [App\Http\Controllers\PackingController::class, 'addBulkPacking']);

    
    Route::get('/packing', [PackingController::class, 'index']);
    Route::get('/packing/create', [PackingController::class, 'create']);
    Route::post('/packing/store', [PackingController::class, 'store']);
    Route::get('/packing/show/{id}', [PackingController::class, 'show']);
    Route::get('/packing/print/{id}', [PackingController::class, 'printPacking']);
    Route::get('/packing/print-all-invoices/{id}', [PackingController::class, 'printAllInvoices']);
    Route::get('/packing/edit/{id}', [PackingController::class, 'edit']);
    Route::get('/packing/destroy/{id}', [PackingController::class, 'destroy']);
    ...
    Route::get('/import-opening-stock/call-stock', [ImportOpeningStockController::class, 'callStockSo']);
    ...
    Route::get('/import-opening-stock/import-delete-products', [ImportOpeningStockController::class, 'importDeleteProductIndex']);
    Route::post('/import-opening-stock/import-delete-products', [ImportOpeningStockController::class, 'importDeleteProduct']);


    //Sell return
    
    Route::get('validate-staff-pin/{pin_staff}', [SellReturnController::class, 'validateStaffPinn']);
    ...
    Route::get('/stock-opname/show/{id}', [StockOpnameController::class, 'show']);
    Route::get('/stock-opname/edit/{id}', [StockOpnameController::class, 'edit']);
    Route::get('/stock-opname/destroy/{id}', [StockOpnameController::class, 'destroy']);
Route::get('stock-opname/fetch-stock-data', [StockOpnameController::class, 'fetchStockData']);
Route::get('stock-opname/get-variations', [StockOpnameController::class, 'getVariations']);
Route::get('stock-opname/get-current-stock', [StockOpnameController::class, 'getCurrentStock']);

Route::get('stock-opname/get-products', [StockOpnameController::class, 'getProducts']);

    Route::get('/reportday', [ReportdayController::class, 'index']);
    Route::get('/reportday/create', [ReportdayController::class, 'create']);
    Route::post('/reportday/store', [ReportdayController::class, 'store']);
    Route::get('/reportday/show/{id}', [ReportdayController::class, 'show']);
    Route::get('/reportday/edit/{id}', [ReportdayController::class, 'edit']);
    Route::get('/reportday/destroy/{id}', [ReportdayController::class, 'destroy']);
    ...
    Route::get('get-sells-orders', [PurchaseOrderController::class, 'getSellsOrders']);
    Route::get('get-sells-order-lines/{sells_id}', [PurchaseController::class, 'getSellsOrderLines']);
...
Route::middleware(['auth'])->group(function () {
    Route::get('/logout/{id}', [App\Http\Controllers\Auth\LoginController::class, 'logout'])->name('logout');
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/purchases/printwithsellprice/{id}', [PurchaseController::class, 'printInvoiceWithSellPrice']);
    ...
    // Mobile 
    Route::get('/home-mobile', [MobileController::class, 'index']);
    Route::get('/home-mobile/get-totals', [MobileController::class, 'getTotals']);
    
    Route::get('/home-mobile/profit-loss', [MobileController::class, 'profitLoss']);
    Route::get('/grafik-mobile', [MobileController::class, 'grafikMobile']);
    Route::get('/activity-log-mobile', [MobileController::class, 'activityLogMobile']);
    // Aktivitas
    Route::get('/activity-mobile', [MobileController::class, 'ActivityMobile']);
    Route::get('/pengajuan-pembelian', [MobileController::class, 'pengajuanPembelian']);
    Route::get('/pengajuan-pembelian-detail/{id}', [MobileController::class, 'pengajuanPembelianDetail']);
    Route::get('/update-pengajuan-acc/{id}', [MobileController::class, 'updatePengajuanAcc']);
    Route::get('/update-pengajuan-dec/{id}', [MobileController::class, 'updatePengajuanDec']);

    // User Profile 
    Route::get('/user/profile-mobile', [UserController::class, 'getProfileMobile'])->name('user.getProfileMobile');
    Route::post('/user/update-mobile', [UserController::class, 'updateProfileMobile'])->name('user.updateProfileMobile');
    Route::post('/user/update-password-mobile', [UserController::class, 'updatePasswordMobile'])->name('user.updatePasswordMobile');
